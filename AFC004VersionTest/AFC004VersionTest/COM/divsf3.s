 ...
 *         Single-precision floating-point division elementary operation.
 *
 *  @date 
 *
 *  @author 
 ...
 *  <BR>
 *
 *  @note $Id: divsf3.s 5889 2008-09-23 17:49:31Z karthikn $ <BR>
...
/**
 * @brief This function computes Single-precision floating-point subtraction.
 *
 * @par <b> Detailed Description: </b>
 *     - IEEE-754 division elementary operation. The quotient (a / b) is calculated and rounded to nearest.
 *\verbatim
 *
 ...
 *      The function returns to the caller by branching to one of three exit blocks:
 *
 *      __fbopExit:
 *      -----------
