 ...
 *  <BR>
 *
 *  @note $Id: addsf3.s 5889 2008-09-23 17:49:31Z karthikn $ <BR>
 ...
 *    IEEE-754 subtraction elementary operation.The difference (a - b) is calculated as
 *    the sum (a + (-b)). This function changes the sign of b, and falls through to the
 *    addition function.
 *
 * @author
 *
...
/**
 * @brief This function computes Single-precision floating-point addition.
 *
 * @par <b> Detailed Description: </b>
